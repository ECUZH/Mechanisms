...
public class testMechanisms {
	...
	*//*
	...
	public void testDoubleAuction2BuyersVCG() throws Exception
	{
		...
		assertTrue( allocation.getAllocatedBundlesByIndex(allocation.getAuctioneerIndexById(1)).size() == 1 );
		assertTrue( allocation.getAllocatedBundlesByIndex(allocation.getAuctioneerIndexById(1)).get(0) == 1 );
