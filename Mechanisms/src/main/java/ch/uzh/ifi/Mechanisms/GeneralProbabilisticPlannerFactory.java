...
public class GeneralProbabilisticPlannerFactory implements IPlannerFactory 
{

	/*
	 * Constructor.
	 */
	public GeneralProbabilisticPlannerFactory(int numberOfBuyers, int numberOfSellers, List<Type> types, boolean isInjectable, int numberOfPlans, int minSellersPerPlan, int maxSellersPerPlan)
	{
	...
	public Planner producePlanner() 
	{
		...
		GeneralProbabilisticPlanner planner = new GeneralProbabilisticPlanner(_numberOfBuyers, _numberOfSellers, _types, System.nanoTime());
	...
	{
		GeneralProbabilisticPlanner planner = new GeneralProbabilisticPlanner(_numberOfBuyers, _numberOfSellers, _types, seed);
		planner.setNumberOfPlans(_numberOfPlans);
		planner.setMinSellersPerPlan(_minSellersPerPlan);
		planner.setMaxSellersPerPlan(_maxSellersPerPlan);
